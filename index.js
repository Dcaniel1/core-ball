gameurl = 'http://funclubmedia.com/m9game/game/73/';
imgUrl = "http://funclubmedia.com/m9game/game/73/icon.png";
...
"undefined" == typeof window.define && (window.define = function() {}, window.define.amd = 1),
    ...
    $AJB.general.Game = function() {
                    ...
                    i.switchStage(0, function() {
                        h.enabled = !1,
                            ...
                            wx.onMenuShareAppMessage({
                                title: "Core Ballï¼ŒLevel" + D + "ï¼",
                                desc: "Core Ballï¼ŒLevel" + D + "ï¼",
                                link: gameurl,
                                imgUrl: imgUrl,
                                trigger: function(res) {
                                    // ä¸è¦å°è¯•åœ¨triggerä¸­ä½¿ç”¨ajaxå¼‚æ­¥è¯·æ±‚ä¿®æ”¹æœ¬æ¬¡åˆ†äº«çš„å†…å®¹ï¼Œå› ä¸ºå®¢æˆ·ç«¯åˆ†äº«æ“ä½œæ˜¯ä¸€ä¸ªåŒæ­¥æ“ä½œï¼Œè¿™æ—¶å€™ä½¿ç”¨ajaxçš„å›žåŒ…ä¼šè¿˜æ²¡æœ‰è¿”å›ž
                            ...
                            // 2.2 ç›‘å¬â€œåˆ†äº«åˆ°æœ‹å‹åœˆâ€æŒ‰é’®ç‚¹å‡»ã€è‡ªå®šä¹‰åˆ†äº«å†…å®¹åŠåˆ†äº«ç»“æžœæŽ¥å£
                            ...
                            // 2.3 ç›‘å¬â€œåˆ†äº«åˆ°QQâ€æŒ‰é’®ç‚¹å‡»ã€è‡ªå®šä¹‰åˆ†äº«å†…å®¹åŠåˆ†äº«ç»“æžœæŽ¥å£
                            wx.onMenuShareQQ({
                                title: "Core Ballï¼ŒLevel" + D + "ï¼",
                                desc: "Core Ballï¼ŒLevel" + D + "ï¼",
                                link: gameurl,
        ...
        var h, i, j, k = $AJB.general.Scene(),
            ...
            y = 60,
            z = "core-ball-level",
            A = "Core Ballï¼ŒLevel #{level}",
            B = "Core Ballï¼ŒLevel #{level} http://funclubmedia.com/m9game/game/73/",
            C = m(s),
            D = +o.getValue(z) || 1,
            E = !1,
            F = 0,
...
ajax.post('http://funclubmedia.com/m9game/game/73/', {
    ...
    wx.ready(function() {
        ...
        // 2.1 ç›‘å¬â€œåˆ†äº«ç»™æœ‹å‹â€ï¼ŒæŒ‰é’®ç‚¹å‡»ã€è‡ªå®šä¹‰åˆ†äº«å†…å®¹åŠåˆ†äº«ç»“æžœæŽ¥å£
        wx.onMenuShareAppMessage({
            title: "Core Ballï¼ŒLevel" + GlobalLevel + "ï¼",
            desc: "Core Ballï¼ŒLevel" + GlobalLevel + "ï¼",
            link: gameurl,
            imgUrl: imgUrl,
            trigger: function(res) {
                // ä¸è¦å°è¯•åœ¨triggerä¸­ä½¿ç”¨ajaxå¼‚æ­¥è¯·æ±‚ä¿®æ”¹æœ¬æ¬¡åˆ†äº«çš„å†…å®¹ï¼Œå› ä¸ºå®¢æˆ·ç«¯åˆ†äº«æ“ä½œæ˜¯ä¸€ä¸ªåŒæ­¥æ“ä½œï¼Œè¿™æ—¶å€™ä½¿ç”¨ajaxçš„å›žåŒ…ä¼šè¿˜æ²¡æœ‰è¿”å›ž
        ...
        // 2.4 ç›‘å¬â€œåˆ†äº«åˆ°å¾®åšâ€æŒ‰é’®ç‚¹å‡»ã€è‡ªå®šä¹‰åˆ†äº«å†…å®¹åŠåˆ†äº«ç»“æžœæŽ¥å£
        wx.onMenuShareWeibo({
            title: "Core Ballï¼ŒLevel" + GlobalLevel + "ï¼",
            desc: "Core Ballï¼ŒLevel" + GlobalLevel + "ï¼",
            link: gameurl,
